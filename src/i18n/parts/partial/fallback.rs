...
pub(in crate::i18n) const I18N_STRING_KEYS: &[&str] = &[
    ...
    "preferences_document_loading_preset",
    "preferences_document_loading_balanced",
    "preferences_document_loading_low_memory",
    "preferences_document_loading_high_performance",
    "preferences_document_max_resident_mib",
    "preferences_document_max_resident_lines",
    "preferences_document_max_structural_units",
