...
pub(in crate::i18n) const I18N_STRING_KEYS: &[&str] = &[
    ...
    "menu_new_window",
    "menu_new_tab",
    "new_document_untyped",
    "new_document_markdown",
    "new_document_json",
    "new_document_csv",
    "json_graph_search_placeholder",
    "json_graph_search_previous",
    "json_graph_search_next",
    "json_graph_preview_unavailable",
    "json_graph_generating",
    "json_graph_generating_detail",
    "json_graph_focus_subtree",
    "json_graph_reset_root",
    "json_graph_stale",
    "json_graph_source_changed",
    "json_graph_truncated",
    "json_graph_show_more_template",
    "json_graph_details_title",
    "json_graph_content",
    "json_graph_path",
    ...
    "json_graph_zoom_out",
    "json_graph_zoom_in",
    "json_graph_locate_source",
    "json_graph_copy_path",
    "json_graph_copy_content",
    "json_graph_collapse",
    "json_graph_expand",
    "json_graph_edit_value",
    "json_graph_edit_help",
    "json_graph_edit_invalid",
    "json_graph_edit_too_large_template",
    "json_graph_live_edit",
    "json_graph_live_edit_hint",
    "json_graph_reload_value",
    "json_graph_edit_source",
    "large_document",
    "menu_close_window",
    "menu_close_tab",
    ...
    "preferences_document_loading",
    "preferences_document_max_resident_mib",
    ...
    "document_sidebar_structure",
    "document_sidebar_columns",
    "document_sidebar_info",
    "document_sidebar_text",
    "document_sidebar_format",
    "document_sidebar_size",
    "document_sidebar_lines",
    "document_sidebar_encoding",
    "document_sidebar_line_endings",
    "document_sidebar_loading",
    "document_sidebar_empty",
    "document_sidebar_rows_template",
    "document_sidebar_items_limit",
    "document_sidebar_column_fallback",
    "status_bar_document_sidebar",
    ...
    "file_open_failed_title",
    "file_open_failed_message",
    "file_open_with_system",
    "file_reveal_in_manager",
    "workspace_open",
    "workspace_copy_path",
    "workspace_copy_relative_path",
    "workspace_refresh",
    "workspace_delete",
    "workspace_delete_title",
...
macro_rules! merge_i18n_strings {
    ($source:ident, $defaults:ident; $($field:ident),+ $(,)?) => {{
        ...
        let large_document = match $source.large_document {
            Some(custom) => {
                let mut merged = $defaults.large_document;
                merged.extend(custom);
                merged
            }
            None => $defaults.large_document,
        };
        I18nStrings {
