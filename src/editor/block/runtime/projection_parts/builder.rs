...
impl ExpandedInlineProjection {
    ...
    #[cfg(test)]
    pub(in super::super) fn pointer_target_offset(&self, offset: usize) -> usize {
    ...
    pub(in super::super) fn collapsed_affinity_for_display_offset(
        &self,
        offset: usize,
    ...
    pub(in super::super) fn caret_closes_span_at_clean(&self, clean: usize) -> bool {
    ...
    pub(in super::super) fn display_offset_for_clean_cursor(
        &self,
        clean: usize,
    ...
    pub(in super::super) fn move_left_target(
        &self,
        offset: usize,
    ...
    pub(in super::super) fn move_right_target(
        &self,
        offset: usize,
    ) -> Option<(usize, CollapsedCaretAffinity)> {
        for segment in &self.segments {
    ...
    pub(in super::super) fn link_run_fully_covering_range(
        &self,
        range: &Range<usize>,
    ...
    pub(in super::super) fn link_run_for_clean_range(
        &self,
    ...
    pub(in super::super) fn footnote_run_fully_covering_range(
        &self,
        range: &Range<usize>,
