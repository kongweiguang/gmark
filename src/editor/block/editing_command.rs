...
#[path = "../commands/block/command_registry.rs"]
mod command_registry;
use command_registry::descriptor;
pub(crate) use command_registry::{EditingCommandHistory, editing_command_specs, filter_commands};
#[cfg(test)]
use command_registry::{normalized_recent_commands, record_recent_command};
