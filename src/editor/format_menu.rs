...
mod tests {
    use super::{
        DocumentMenuCapabilities, DocumentMenuFormat, FormatMenuDisabledReason, FormatMenuItemKind,
        format_menu_item_states, menu_item_kinds,
    };
    ...
    fn probe_formats_keep_jsonl_and_tab_delimited_documents_distinct() {
        ...
        assert_eq!(
            DocumentMenuFormat::from_document_format(&DocumentFormat::Delimited {
                delimiter: b','
            }),
