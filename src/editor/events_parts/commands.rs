...
impl Editor {
    ...
    fn complete_paste_image_request(
        &mut self,
        block: Entity<super::Block>,
        leading: &InlineTextTree,
        source: &PastedImageSource,
    ...
    /// Routes the app-level Markdown insert action through the same picker and
    /// transaction controller as slash commands and the editor context menu.
