...
pub(super) fn localized_action_description(
    ...
    if language_id.starts_with("zh") {
        ...
        let description = match action_id.as_str() {
            ...
            "cancelformatting" => "取消当前正在进行的格式化任务",
            "collapsefold" => "折叠当前源码区域",
            "collapseallfolds" => "折叠全部源码区域",
            "expandfold" => "展开当前源码区域",
            "expandallfolds" => "展开全部源码区域",
            "focusstructuredcolumns" => "将焦点移到结构化视图的列工具",
            "focusstructuredfilter" => "将焦点移到结构化视图的筛选器",
            "formatdocument" => "格式化当前文档",
            "formatselection" => "格式化当前选中的内容",
            "showdocumentoutline" => "打开当前文档的大纲",
            "showstructureview" => "打开当前文档的结构化视图",
            "showstructuredinspector" => "打开结构化数据检查器",
            "showdocumentinfo" => "查看当前文档的信息",
