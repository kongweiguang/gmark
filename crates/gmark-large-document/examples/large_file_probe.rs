...
use gmark_large_document::{
    ...
    LargeDocumentAdapter, LineIndex, MarkdownTableIndex, PieceDocument, ProbeOptions,
    SearchCancellation, SearchOptions, ViewportRequest, probe_file, search_file_source,
...
fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    let adapter = LargeDocumentAdapter::new(PieceDocument::open(source.clone(), lines.clone())?);
